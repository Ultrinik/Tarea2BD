...
usuarios = [
    (0, 'Admin', 'Admin',       'admin@admin',                 '123',           r.randint(1,10), generateFecha(), True),
    (1, 'Carlos', 'Matos',      'carlos.matos@bitconnect.com', '68B826DEFEB8A', r.randint(1,10), generateFecha(), False),
